      ...
      <Container style={{display: 'flex'}}>
        ...
        <View
          ...
          <Text style={styles.subHeader}>
            Your e-RCS1 no. for this transaction is
          </Text>
          ...
          <Text style={styles.subHeader1}>
            ...
            registered email address. You may print and present it to your
            chosen facility to avail your consultation.
          </Text>
        </View>
        <View style={styles.viewButton}>
          <Button info style={styles.buttonResend}>
            <Title>Resend e-mail</Title>
          </Button>
          <Button success style={styles.buttonHome} onPress={() => this.props.navigation.navigate('DashboardPage')}>
