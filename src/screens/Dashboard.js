      ...
      <Container style={{display: 'flex', flex: 1, backgroundColor: '#f5f5f5'}}>
        ...
        <ScrollView>
          <View style={styles.swiperFeatures}>
            <ImageBackground
              source={require('../../assets/images/intelliappheader.png')}
                ...
                <View style={styles.child}>
                  <Card style={styles.mainCardStyle}>
                    <CardItem
                      ...
                      <Text style={styles.mainCardText}>
                        We’re constantly striving to make processes better,
                        faster, more high-tech and high-touch – all to make your
                        life simpler and healthier.
                      </Text>
                    </CardItem>
                  </Card>
                </View>
